...
class suppliers_listing_report(osv.osv_memory):
	_name = 'suppliers.listing.report'
	_description = 'Suppliers Listing Report'
	...
	def print_report(self, cr, uid, ids, context=None): 
		...
		return {
		    ...
		    'report_name': 'suppliers.listing.report',
		    'datas': datas,
	}			
